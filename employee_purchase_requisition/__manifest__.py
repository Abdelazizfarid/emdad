...
###############################################################################
{
    ...
    'data': [
        ...
        'report/employee_sales_requisition_report.xml',
        'report/employee_sales_requisition_templates.xml',
        'views/custom_location.xml',
        'views/custom_purchase_requisition.xml',
        'views/custom_sales_requisition.xml',
        # 'views/custom_res_user.xml',
    ],
